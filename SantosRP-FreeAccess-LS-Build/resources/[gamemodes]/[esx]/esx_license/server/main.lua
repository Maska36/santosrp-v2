...
function AddInstantLicense(target, type)
...
RegisterServerEvent('esx_license:addLicenseTest')
AddEventHandler('esx_license:addLicenseTest', function(target, type)
	AddInstantLicense(target, type)
end)
