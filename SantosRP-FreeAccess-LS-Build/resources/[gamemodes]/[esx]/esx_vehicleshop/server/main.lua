...
TriggerEvent('esx_phone:registerNumber', 'concess', _U('dealer_customers'), false, false)
...
AddEventHandler('esx_vehicleshop:annonce', function(result)
  ...
  for i=1, #xPlayers, 1 do
	TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], "CONCESSIONNAIRE", "Annonce", text, "CHAR_CARSITE", 4)
  end
end)
