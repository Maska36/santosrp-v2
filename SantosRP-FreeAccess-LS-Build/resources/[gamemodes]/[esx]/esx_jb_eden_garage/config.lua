...
Config.MecanoBlip	= {sprite= 290, color = 26}
Config.Price = 120 -- pound price to get vehicle back
...
Config.Garages = {
	Garage_Centre = {
		Pos = {x=594.996, y=87.339, z=93.870},
		Marker = { w= 1.0, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage",
		SpawnPoint = {
			Pos = {x=609.948, y=95.015, z=93.669},
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour sortir votre véhicule"
		},
		DeletePoint = {
			Pos = {x=620.872, y=124.603, z=93.798},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour rentrer votre véhicule"
		}, 	
	},
	Garage_NightClub = {
		Pos ={x = 664.544,y = 629.024,z = 129.911 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage",
		SpawnPoint = {
			Pos = {x = 657.646,y = 630.719,z = 129.911 },
			Heading = 340.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour sortir votre véhicule"
		},
		DeletePoint = {
			Pos = {x = 650.576,y = 625.058,z = 129.911 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour rentrer votre véhicule"
		}, 	
	},
	Garage_Centre2 = {
		Pos = {x = -1523.191,y = -451.017,z = 36.596},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage",
		SpawnPoint = {
			Pos = {x = -1519.22,y = -434.582,z = 36.442},
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour sortir votre véhicule"
		},
		DeletePoint = {
			Pos = {x = -1528.022,y = -443.280,z = 36.442},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour rentrer votre véhicule"
		}, 	
	},
	-- Garage_Paleto = {
	-- 	Pos = {x=105.359, y=6613.586, z=33.3973},
	-- 	Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
	-- 	Name = 'Garage',
	-- 	HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage",
	-- 	SpawnPoint = {
	-- 		Pos = {x=128.7822, y= 6622.9965, z= 32.7828},
	-- 		Heading = 160.0,
	-- 		Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
	-- 		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour sortir votre véhicule"
	-- 	},
	-- 	DeletePoint = {
	-- 		Pos = {x=126.3572, y=6608.4150, z=32.8565},
	-- 		Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
	-- 		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour rentrer votre véhicule"
	-- 	}, 	
	-- },
	Garage_SandyShore = {
		Pos = {x=1694.571, y=3610.924, z=36.319},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage",
		SpawnPoint = {
			Pos = {x=1713.492, y= 3598.938, z= 36.338},
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour sortir votre véhicule"
		},
		DeletePoint = {
			Pos = {x = 1695.156,y = 3601.061,z = 36.530},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour rentrer votre véhicule"
		}, 	
	},
	-- Garage_Ocean1 = {
	-- 	Pos = {x = -3140.323,y = 1124.463,z = 21.706},
	-- 	Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
	-- 	Name = 'Garage',
	-- 	HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage",
	-- 	SpawnPoint = {
	-- 		Pos = {x = -3132.638,y = 1126.662,z = 21.667},
	-- 		Heading = 160.0,
	-- 		Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
	-- 		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour sortir votre véhicule"
	-- 	},
	-- 	DeletePoint = {
	-- 		Pos = {x = -3136.902,y = 1102.685,z = 21.654},
	-- 		Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
	-- 		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour rentrer votre véhicule"
	-- 	}, 	
	-- },
	-- Garage_Ocean2 = {
	-- 	Pos = {x = -2982.561,y = 327.506,z = 15.935},
	-- 	Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
	-- 	Name = 'Garage',
	-- 	HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage",
	-- 	SpawnPoint = {
	...
	-- },
	-- Garage_Sud = {
	-- 	Pos = {x = 443.6696,y = -1969.4372,z = 25.401},
	-- 	Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
	-- 	Name = 'Garage',
	-- 	HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage",
	-- 	SpawnPoint = {
	-- 		Pos = {x = 437.8140,y = -1958.572,z = 23.957},
	-- 		Heading = 182.0,
	-- 		Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
	-- 		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour sortir votre véhicule"
	-- 	},
	-- 	DeletePoint = {
	-- 		Pos = {x = 457.91,y = -1971.343,z = 23.553},
	-- 		Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
	-- 		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour rentrer votre véhicule"
	-- 	}, 	
	-- },
	...
	Garage_mirrorpark = {
		Pos = {x = 1033.9229736328,y = -767.10662841797,z = 57.003326416016 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage",
		SpawnPoint = {
			Pos = {x = 1040.6834716797,y = -778.18170166016,z = 57.022853851318 },
			Heading = 359.92,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour sortir votre véhicule"
		},
		DeletePoint = {
			Pos = {x = 1022.7816772461,y = -763.78955078125,z = 56.961227416992 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour rentrer votre véhicule"
		}, 	
	},
...
--[[Config.BoatGarages = {
	BoatGarage_Centre = {
		...
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage de navire",
		SpawnPoint = {
			Pos = {x = -736.47064208984,y = -1342.4702148438,z = 1.0 },
			MarkerPos = {x = -733.58,y = -1338.62,z = 1.5 },
			Heading = 230.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour sortir votre navire"
		},
		DeletePoint = {
			Pos = {x = -740.06408691406,y = -1361.8474121094,z = 1.8801808655262 },
			Marker = { w= 3.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour rentrer votre navire"
		}, 	
	},
}
...
Config.AirplaneGarages = {
	AirplaneGarage_Centre = {
		...
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour ouvrir le garage de aviation",
		SpawnPoint = {
			Pos = {x = -1285.1153564453,y = -3382.1647949219,z = 13.940155029297 },
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour sortir votre engin d'aviation"
		},
		DeletePoint = {
			Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 13.940155029297 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Appuyez sur ~INPUT_PICKUP~ pour rentrer votre engin d'aviation"
		}, 	
	},
}
--]]