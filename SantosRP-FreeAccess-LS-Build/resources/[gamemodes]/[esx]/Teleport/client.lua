...
AddEventHandler('tp:hasEnteredMarker', function(zone)
    ...
    if zone == 'YakuzaEnter' then
    	CurrentAction = zone
    elseif zone == 'YakuzaExit' then
    	CurrentAction = zone
    elseif zone == 'WeedEnter' then
    	CurrentAction = zone
    elseif zone == 'WeedExit' then
    	CurrentAction = zone
    elseif zone == 'MethEnter' then
    	CurrentAction = zone
    elseif zone == 'MethExit' then
    	CurrentAction = zone
    elseif zone == 'CokeEnter' then
    	CurrentAction = zone
    elseif zone == 'CokeExit' then
    	CurrentAction = zone
    end
