...
function UpdatePlayerTable(connectedPlayers)
	...
	local ambulance, police, taxi, mechanic, cardealer, estate, players = 0, 0, 0, 0, 0, 0, 0
	...
	SendNUIMessage({
		...
		jobs   = {ambulance = ambulance, police = police, taxi = taxi, mechanic = mechanic, cardealer = cardealer, estate = estate, player_count = players}
	})
end
