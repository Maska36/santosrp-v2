    	...
    	elseif data.current.value == 'annonce' then
	        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'annonce', {
	          ...
	          function (data, menu)
	            ...
	            TriggerServerEvent('esx_MJ:annonce', ContenuReason)
	          end,
	          function (data, menu)
	            menu.close()
	          end)
	...
	if Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.grade_name ~= 'recrue' then
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mechanic_harvest', {
			...
			if data.current.value == 'gaz_bottle' then
				TriggerServerEvent('esx_MJ:startHarvest')
			elseif data.current.value == 'fix_tool' then
				TriggerServerEvent('esx_MJ:startHarvest2')
			elseif data.current.value == 'caro_tool' then
				TriggerServerEvent('esx_MJ:startHarvest3')
			end
		end, function(data, menu)
			menu.close()
	...
	if Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.grade_name ~= 'recrue' then
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mechanic_craft', {
			...
			if data.current.value == 'blow_pipe' then
				TriggerServerEvent('esx_MJ:startCraft')
			elseif data.current.value == 'fix_kit' then
				TriggerServerEvent('esx_MJ:startCraft2')
			elseif data.current.value == 'caro_kit' then
				TriggerServerEvent('esx_MJ:startCraft3')
			end
		end, function(data, menu)
			menu.close()
					...
					if NPCOnJob then
						if NPCTargetDeleterZone then
							...
							if CurrentlyTowedVehicle == NPCTargetTowable then
								...
								TriggerServerEvent('esx_MJ:onNPCJobMissionCompleted')
								StopNPCJob()
...
function OpenGetStocksMenu()
	ESX.TriggerServerCallback('esx_MJ:getStockItems', function(items)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_MJ:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	ESX.TriggerServerCallback('esx_MJ:getPlayerInventory', function(inventory)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_MJ:putStockItems', itemName, count)
...
RegisterNetEvent('esx_MJ:onHijack')
AddEventHandler('esx_MJ:onHijack', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('esx_MJ:onCarokit')
AddEventHandler('esx_MJ:onCarokit', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('esx_MJ:onFixkit')
AddEventHandler('esx_MJ:onFixkit', function()
	local playerPed = PlayerPedId()
	local coords    = GetEntityCoords(playerPed)
...
AddEventHandler('esx_MJ:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_MJ:hasExitedMarker', function(zone)
	if zone =='VehicleDelivery' then
		NPCTargetDeleterZone = false
	elseif zone == 'Craft' then
		TriggerServerEvent('esx_MJ:stopCraft')
		TriggerServerEvent('esx_MJ:stopCraft2')
		TriggerServerEvent('esx_MJ:stopCraft3')
	elseif zone == 'Garage' then
		TriggerServerEvent('esx_MJ:stopHarvest')
		TriggerServerEvent('esx_MJ:stopHarvest2')
		TriggerServerEvent('esx_MJ:stopHarvest3')
	end
...
AddEventHandler('esx_MJ:hasEnteredEntityZone', function(entity)
	local playerPed = PlayerPedId()
...
AddEventHandler('esx_MJ:hasExitedEntityZone', function(entity)
	...
	while true do
		...
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic' then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('esx_MJ:hasEnteredMarker', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('esx_MJ:hasExitedMarker', LastZone)
			end
	...
	while true do
		...
		if closestDistance ~= -1 and closestDistance <= 3.0 then
			if LastEntity ~= closestEntity then
				TriggerEvent('esx_MJ:hasEnteredEntityZone', closestEntity)
				LastEntity = closestEntity
			end
		else
			if LastEntity then
				TriggerEvent('esx_MJ:hasExitedEntityZone', LastEntity)
				LastEntity = nil
			end
		end
	end
