...
Config.Strings = {
	ExitVehicle = "Sors du véhicule d'abord !",
	EToRefuel = "Appuyez sur ~g~E~w~ pour mettre de l'essence",
	JerryCanEmpty = "Le bidon est vide",
	FullTank = "Le réservoir est plein",
	PurchaseJerryCan = "Appuyez sur ~g~E~w~ pour acheter un bidon au prix de ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Appuyez sur ~g~E~w~ pour arreter le ravitaillement d'essence",
	CancelFuelingJerryCan = "Appuyez sur ~g~E~w~ pour arreter le ravitaillement d'essence",
	NotEnoughCash = "Vous n'avez pas assez d'argent",
	RefillJerryCan = "Appuyez sur ~g~E ~w~ pour remplir le bidon d'essence",
	NotEnoughCashJerryCan = "ous n'avez pas assez d'argent pour remplir le bidon",
...
if not Config.UseESX then
	...
	Config.Strings.RefillJerryCan = "Appuyez sur ~g~E~w~ pour remplir un bidon d'essence"
end
