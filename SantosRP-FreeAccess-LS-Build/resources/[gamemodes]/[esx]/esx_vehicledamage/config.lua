cfg = {
	...
	collisionDamageExponent = 0.2,				-- How much should the handling file deformation setting be compressed toward 1.0. (Make cars more similar). A value of 1=no change. Lower values will compress more, values above 1 it will expand. Dont set to zero or negative.
	...
	cascadingFailureThreshold = 130.0,			-- Below this value, health cascading failure will set in
	...
	sundayDriverAcceleratorCurve = 3.75,			-- The response curve to apply to the accelerator. Range 0.0 to 10.0. Higher values enables easier slow driving, meaning more pressure on the throttle is required to accelerate forward. Does nothing for keyboard drivers
