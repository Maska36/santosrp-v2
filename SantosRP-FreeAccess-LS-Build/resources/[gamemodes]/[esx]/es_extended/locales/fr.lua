Locales['fr'] = {
  ...
  ['threw_pickup_prompt'] = '[~y~E~s~] Ramasser',
  -- Salary related
  ...
  ['setorg_param2'] = 'l\'organisation que vous souhaitez assigner',
  ['setorg_param3'] = 'le niveau d\'organisation',
  ...
  ['revive_all'] = 'revive tous le monde',
  ['kick'] = 'kick un joueur',
  ['command_clearmoney'] = 'effacer tout l\'argent liquide',
