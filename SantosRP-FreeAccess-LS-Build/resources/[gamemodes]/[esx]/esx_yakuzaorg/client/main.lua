...
AddEventHandler('esx_yakuzajob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.org and PlayerData.org.name == 'yakuza' and IsPedOnFoot(playerPed) then
...
AddEventHandler('esx_yakuzajob:drag', function(guyId)
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.org ~= nil and PlayerData.org.name == 'yakuza' then
      ...
      for k,v in pairs(Config.YakuzaStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.org ~= nil and PlayerData.org.name == 'yakuza' and PlayerData.org.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  38) and PlayerData.org ~= nil and PlayerData.org.name == 'yakuza' then
        if CurrentAction == 'menu_armory' then
          OpenArmoryMenu(CurrentActionData.station)
        elseif CurrentAction == 'menu_boss_actions' then
          ESX.UI.Menu.CloseAll()
          TriggerEvent('esx_society:openBossOrgMenu', 'yakuza', function(data, menu)
            menu.close()
            CurrentAction     = 'menu_boss_actions'
            CurrentActionMsg  = _U('open_bossmenu')
            CurrentActionData = {}
    ...
    if IsControlPressed(0,  168) and PlayerData.org ~= nil and PlayerData.org.name == 'yakuza' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'yakuza_actions') then
