...
Config.Blip = {
	Pos     = { x = -359.344, y = -134.043, z = 38.681 },
	Sprite  = 446,
	Display = 4,
	Scale   = 0.8,
	Colour  = 5,
...
Config.Zones = {
	...
	CarLift = {
		...
		Text = 'Appuyez sur [~b~E~w~] pour contrôler la machine'
	},

	MechanicActions = {
		Pos   = { x = -338.950, y = -141.505, z = 39.009 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = 0,
		Text  = 'Appuyez sur [~b~E~w~] pour ~g~ouvrir~w~ le menu'
	},

	Garage = {
		Pos   = { x = 1384.628, y = -2080.208, z = 52.608 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = 1,
		Text  = 'Appuyez sur [~b~E~w~] pour ~g~récolter~w~ des outils'
	},
	...
	Craft = {
		...
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = 1,
		Text  = 'Appuyez sur [~b~E~w~] pour ~g~craft~w~ des outils'
	},

	VehicleSpawnPoint = {
		Pos   = {x = -358.782, y = -115.178, z = 38.696 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
		Text  = 'TESTE'
	},
	...
	VehicleDeleter = {
		Pos   = { x = -362.257, y = -126.876, z = 38.695 },
		Size  = { x = 3.0, y = 3.0, z = 1.0 },
		Type  = 1,
		Text  = 'Appuyez sur [~b~E~w~] pour ~g~ranger~w~ votre véhicule'
	},
	...
	ls1 = {
		Pos   = { x = -326.815, y = -144.465, z = 39.060 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Marker= 1,
		Text  = 'Appuyez sur [~b~E~w~] pour ~g~customiser~w~ le véhicule'

	},
	
	ls2 = {
		Pos   = { x = -323.806, y = -131.969, z = 38.95 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Marker= 1,
		Text  = 'Appuyez sur [~b~E~w~] pour ~g~customiser~w~ le véhicule'
	},
	...
	ls3 = {
		Pos   = { x = -340.851, y = -128.293, z = 39.009 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Marker= 1,
		Text  = 'Appuyez sur [~b~E~w~] pour ~g~customiser~w~ le véhicule'
	}
