				...
				if distance < 1.5 then
					...
					if(IsControlJustReleased(1, 38))then
						...
						if (tmp_action.type == "cleaning") then
							...
							local vassouspawn = CreateObject(vassoumodel, cSCoords.x, cSCoords.y, cSCoords.z, 1, 1, 1)
						...
						if (tmp_action.type == "gardening") then
							local cSCoords = GetOffsetFromEntityInWorldCoords(GetPlayerPed(PlayerId()), 0.0, 0.0, -5.0)
							local spatulaspawn = CreateObject(spatulamodel, cSCoords.x, cSCoords.y, cSCoords.z, 1, 1, 1)
