...
TriggerEvent('esx_society:registerSociety', 'ammu', 'Armurerie', 'society_ammu', 'society_ammu', 'society_ammu', {type = 'public'})
...
AddEventHandler('esx_ammujob:annonce', function(result)
  ...
  for i=1, #xPlayers, 1 do
    TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], "ARMURERIE", "Annonce", text, "CHAR_AMMUNATION", 4)
  end
end)
...
ESX.RegisterServerCallback('esx_ammujob:addArmoryWeapon', function(source, cb, weaponName, removeWeapon)
  local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('esx_ammujob:buyItem')
AddEventHandler('esx_ammujob:buyItem', function(itemName, price)
  local _source = source
...
RegisterServerEvent('esx_ammujob:buyPPA')
AddEventHandler('esx_ammujob:buyPPA', function(player, license, price)
  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_ammujob:buyAmmos')
AddEventHandler('esx_ammujob:buyAmmos', function(itemName, price)
  local _source = source
  local xPlayer = ESX.GetPlayerFromId(_source)
  local sourceItem = xPlayer.getInventoryItem(itemName)
  local amount = 1
