...
AddEventHandler('esx_vagosjob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.org and PlayerData.org.name == 'vagos' and IsPedOnFoot(playerPed) then
...
AddEventHandler('esx_vagosjob:drag', function(guyId)
  ...
  while true do
    ...
    if PlayerData.org ~= nil and PlayerData.org.name == 'vagos' then
      ...
      for k,v in pairs(Config.VagosStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.org ~= nil and PlayerData.org.name == 'vagos' and PlayerData.org.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  38) and PlayerData.org ~= nil and PlayerData.org.name == 'vagos' then
        if CurrentAction == 'menu_armory' then
          OpenArmoryMenu(CurrentActionData.station)
        elseif CurrentAction == 'menu_boss_actions' then
          ESX.UI.Menu.CloseAll()
          TriggerEvent('esx_society:openBossOrgMenu', 'vagos', function(data, menu)
            menu.close()
            CurrentAction     = 'menu_boss_actions'
            CurrentActionMsg  = _U('open_bossmenu')
            CurrentActionData = {}
    ...
    if IsControlPressed(0,  168) and PlayerData.org ~= nil and PlayerData.org.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'vagos_actions') then
