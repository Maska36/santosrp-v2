	...
	def.presentCard([==[{
		...
		"body":[
		{
		    ...
		    "columns": [
		    {
		        ...
		        {
		            "type": "Image",
		            "url": "https://i.imgur.com/zatvfTd.png",
		            "size": "extraLarge"
		        }],
		    	"width": "auto"
		    }]
		...
		{
		    "type":"TextBlock",
		    "text":"Veuillez entrer le mot de passe du serveur, trouvable sur le discord : discord.gg/santosroleplay",
		    "wrap":true
		},
		{
		    "type":"Input.Text",
		...
		},
		{
		    ...
		    "actions":[
		    {
		    	...
		    	"url":"https://discord.gg/santosroleplay"
		    }]
		...
		if data.password and data.password == mdp then
			...
			def.done('Mauvais mot de passe, il est trouvable sur le discord : discord.gg/santosroleplay')
		end
	end)
end)
...
RegisterServerEvent("santosrp-rocade:playerKicked")
AddEventHandler("santosrp-rocade:playerKicked", function(src, points)
...
RegisterServerEvent("santosrp-rocade:playerConnected")
AddEventHandler("santosrp-rocade:playerConnected", function()
