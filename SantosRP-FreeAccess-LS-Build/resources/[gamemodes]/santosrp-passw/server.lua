...
--- CONFIG ---
password = "cléguignol" -- Set server password here
kickMessage = "Mot de passe invalide, vous pourrez le retrouver ici : discord.gg/vP3edQH" -- The invalid password kick message. Default: Invalid Password
timeRanOutMsg = "Vous n'avez pas entrer le mdp a temps - discord.gg/vP3edQH" --Not active yet! Dont worry about this
timeoutMessage = "Mot de passe invalide. Attendez %s avant de vous connectez a nouveau. discord.gg/vP3edQH" -- Displayed if the user tries to attempt too many times, this locks them out of the server for x seconds
