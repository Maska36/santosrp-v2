...
function KeyboardInput(textEntry, inputText, maxLength) -- Thanks to Flatracer for the function.
    AddTextEntry('FMMC_KEY_TIP9', textEntry)
    DisplayOnscreenKeyboard(1, "FMMC_KEY_TIP9", "", inputText, "", "", "", maxLength)
...
AddEventHandler("Fax:ServerPassword:ShowPasswordPrompt", function()
    local password = KeyboardInput("Entrez le MDP du serveur, dispo ici: discord.gg/vP3edQH", "", 10)
    attempts = attempts - 1
