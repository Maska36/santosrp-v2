...
function newPhoneProp()
	...
	--CreateObject(`prop_amb_phone`, GetEntityCoords(PlayerPedId()), true, true, false)
	phoneProp = CreateObject(phoneModel, GetEntityCoords(PlayerPedId()), true, true, false)
	bone = GetPedBoneIndex(PlayerPedId(), 28422)
