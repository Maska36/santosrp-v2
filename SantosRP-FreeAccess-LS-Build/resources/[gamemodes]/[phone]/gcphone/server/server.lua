...
RegisterServerEvent("santos_menuperso:RenameSim")
AddEventHandler("santos_menuperso:RenameSim", function(id, txt, _)
    MySQL.Async.execute('UPDATE user_sim SET label = @label WHERE id=@id', {
        ['@id'] = id,
        ['@label'] = txt
    })
    TriggerClientEvent("esx:showNotification",source,"~g~Vous avez bien renommé votre carte SIM en "..txt)
end)

RegisterServerEvent('santos_menuperso:SetNumber')
AddEventHandler('santos_menuperso:SetNumber', function(numb)
    ...
    if xPlayer then
        ...
        TriggerClientEvent("santos_menuperso:UpdateNumber", _source, numb)
...
ESX.RegisterServerCallback('santos_menuperso:getSim', function(source, cb)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('santos_menuperso:Throw')
AddEventHandler('santos_menuperso:Throw', function(number)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
    ...
    if xPlayer then
        ...
        TriggerClientEvent("santos_menuperso:UpdateNumber", _source, nil)
        ...
        TriggerClientEvent('esx:showNotification', source, '~r~Vous avez jeté votre carte SIM '..number)
    end
end)
...
RegisterServerEvent('santos_menuperso:useSim')
AddEventHandler('santos_menuperso:useSim', function(number)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
    
    if xPlayer then
        TriggerClientEvent("gcPhone:myPhoneNumber", _source, number)
        TriggerClientEvent("santos_menuperso:UpdateNumber", _source, number)
...
RegisterServerEvent('santos_menuperso:GiveNumber')
AddEventHandler('santos_menuperso:GiveNumber', function(target,number)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
    ...
    MySQL.Async.fetchAll('SELECT * FROM `users` WHERE `identifier` = @identifier', {
        ...
        TriggerClientEvent('esx:showNotification', _source, '~r~Vous avez jeté votre carte '.. number)
        TriggerClientEvent('esx:showNotification', target, '~g~Vous avez reçu une carte SIM '.. number)
        TriggerClientEvent("santos_menuperso:syncSim", _source)
        TriggerClientEvent("santos_menuperso:syncSim", target)
    end)
end)
