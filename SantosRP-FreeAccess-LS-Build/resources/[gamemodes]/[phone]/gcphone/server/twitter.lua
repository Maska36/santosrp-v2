...
AddEventHandler('gcPhone:twitter_newTweets', function (tweet)
  ...
  local CHAT_WEBHOOK = "https://canary.discordapp.com/api/webhooks/648166033697538048/2we3bj9LPLdxPpoHJVfbQDHMhytpBwglCRO8t_xjO0vEL_iQYZCFt0AYP9r7phiGuFWQ"
  local headers = {
  ...
  PerformHttpRequest(CHAT_WEBHOOK, function(err, text, headers) end, 'POST', json.encode(data), headers)
end)