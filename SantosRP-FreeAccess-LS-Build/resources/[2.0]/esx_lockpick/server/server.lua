...
ESX.RegisterUsableItem('lockpick', function(source)
	...
	TriggerClientEvent('lockpick:onUse', _source)
end)

RegisterNetEvent('lockpick:removeKit')
AddEventHandler('lockpick:removeKit', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterNetEvent("lockpick:setVehicleDoorsForEveryone")
AddEventHandler("lockpick:setVehicleDoorsForEveryone", function(veh, doors, plate)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
        ...
        getVehData(veh_plate, function(veh_data)
            if veh_data.plate ~= plate then
                ...
                for _,player in pairs(players) do
                    TriggerClientEvent("lockpick:setVehicleDoors", player, table.unpack(veh, doors))
                end
            end
        end)
