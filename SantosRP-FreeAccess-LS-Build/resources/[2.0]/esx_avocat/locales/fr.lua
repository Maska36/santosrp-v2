...
Locales['fr'] = {
	...
	['vigneron_client'] = 'client',
	['transforming_in_progress'] = 'Assemblage des circuits en cours',
	['raisin_taken'] = 'Vous êtes en train de récupérer des circuits',
	['press_traitement'] = 'appuyez sur ~INPUT_CONTEXT~ pour assembler vos circuits',
	['press_collect'] = 'appuyez sur ~INPUT_CONTEXT~ pour récupérer des circuits',
	['press_sell'] = 'appuyez sur ~INPUT_CONTEXT~ pour vendre vos produits',
	['no_jus_sale'] = 'Vous n\'avez pas assez de carte mere',
	['no_vin_sale'] = 'Vous n\'avez pas assez de carte graphique',
	['not_enough_raisin'] = 'Vous n\'avez plus de circuit',
	['grand_cru'] = '~g~Génial, un Intel Core i7 !~w~',
	['no_product_sale'] = 'Vous n\'avez plus de produits',
	['press_traitement_jus'] = 'appuyez sur ~INPUT_CONTEXT~ pour assembler vos circuits'
}
