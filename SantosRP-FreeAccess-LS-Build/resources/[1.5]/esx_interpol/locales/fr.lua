Locales['fr'] = {
  ...
  ['open_interpol'] = 'appuyez sur ~INPUT_CONTEXT~ pour ouvrir le menu',
  -- Armory
  ...
  ['being_searched'] = 'vous vous faite ~y~fouillé(e)~s~ par la ~b~Police~s~',
  -- Vehicle interaction
  ...
  ['interpol_stock'] = 'coffre d\'interpol',
  -- Misc
  ...
  -- Notifications
  ['alert_interpol'] = 'alerte Interpol',
  ['phone_interpol'] = 'interpol',
}
